...
from core.payload import build_search_form
...
def test_download_disclosure_viewer_htmls_rate_limits_by_default(
    ...
    monkeypatch.setattr("core.client.time.sleep", sleep_calls.append)
...
def test_download_kind_viewer_htmls_from_result_folder_collects_acpt_numbers(
    ...
    session = ViewerFakeSession()
    monkeypatch.setattr("core.client.time.sleep", lambda seconds: None)
