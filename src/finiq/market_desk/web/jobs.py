...
class JobManager:
    ...
    def add_log(self, job_id: str, message: str):
        # Note: assumes caller might NOT hold lock, or might hold lock. 
        # To be safe, we check if we already hold the lock or use a reentrant lock if needed.
        # But here we just use the simple lock.
