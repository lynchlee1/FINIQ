...
### 워크플로우 순서
1. 공시내역 다운로드 : 공시 검색 과정에서 필터(판단) 적용
2. 공시내역 변환 : 다운받은 데이터가 있으면 자동, 판단 개입 없음
3. 공시내역 필터링 : 필터링 과정에서 필터(판단) 적용
4. 공시원문 외부 저장 : 다운받을 대상이 정해지면 자동, 판단 개입 없음 (분할저장을 default라고 생각하면)
5. 공시원문 내부 저장 : 다운받을 대상이 정해지면 자동, 판단 개입 없음 (분할저장을 default라고 생각하면)
6. 공시원문 목차 분리 : 목차 선정 과정에서 필터(판단) 적용
7. 공시원문 변환 : 변환할 데이터가 정해지면 자동, 판단 개입 없음
