    ...
    <main className="flex flex-col gap-6 w-full">
      ...
      <Card className="dark:bg-[#161b22] dark:border-[#30363d]">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          ...
          <Button onClick={loadBondSummary} disabled={isFetching} className="dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200">
            결과 불러오기
          </Button>
        </CardHeader>
                      ...
                      filteredRecords.map((record: any) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-slate-400 dark:text-slate-500 font-mono text-[11px]">{record.rcept_no || "-"}</td>
                        ...
                        return members.map((member: any) => (
                          ...
                          >
                            ...
                            <div className="flex flex-col">
                              <code className="text-[11px] font-mono font-bold text-slate-700 dark:text-slate-300">{member.rcept_no}</code>
