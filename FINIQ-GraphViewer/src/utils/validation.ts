...
export const SAMPLE_GRAPH_JSON = JSON.stringify(
  {
    nodes: [
      { id: 'alice', label: 'Alice', type: 'Person', group: 'Engineering', tags: ['staff'] },
      { id: 'bob', label: 'Bob', type: 'Person', group: 'Engineering', tags: ['staff'] },
      { id: 'charlie', label: 'Charlie', type: 'Person', group: 'Product', tags: ['staff'] },
      { id: 'acme', label: 'ACME Corp', type: 'Organization', tags: ['partner'] },
      { id: 'project-x', label: 'Project X', type: 'Project', group: 'Q2', tags: ['priority'] },
    ],
    edges: [
      { source: 'alice', target: 'bob', relation: 'collaborates_with', directed: false, weight: 2 },
      { source: 'alice', target: 'charlie', relation: 'mentors', directed: true, weight: 1 },
      { source: 'bob', target: 'project-x', relation: 'works_on', directed: true, weight: 3 },
      { source: 'charlie', target: 'project-x', relation: 'owns', directed: true, weight: 4 },
      { source: 'acme', target: 'project-x', relation: 'funds', directed: true, weight: 5 },
      { source: 'bob', target: 'charlie', relation: 'reviews_with', directed: false, weight: 1.5 },
      { source: 'alice', target: 'project-x', relation: 'leads', directed: true, weight: 3 },
    ],
  },
  null,
  2,
