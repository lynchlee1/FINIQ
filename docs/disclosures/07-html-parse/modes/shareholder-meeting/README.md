...
#### **세부 설명**
- HTML·metadata·최종 payload의 공통 계약은 [공시원문 변환 공통 규칙](../../README.md)을 따른다.
...
**[Core Processing] 주주총회 안건 추출 기능**
- **목적:** NOTICE·RESULT 형식의 안건을 같은 목록 구조로 만든다.
...
**[Core Processing] 주주총회 선임 내역 기능**
- **목적:** 이사·사외이사·감사 선임 표를 구분해 저장한다.
...
**[Core Processing] 사업목적 변경 추출 기능**
- **목적:** 변경 전·후 내용과 일반 사업목적 내용을 구분한다.
...
**[Core Processing] 주주총회 선택 항목 처리 기능**
- **목적:** NOTICE·RESULT의 실제 제목 변형과 선택적인 상세 목차를 구분한다.
- 별도 유형이 없으면 `1. 결의사항`, `3. 의안 주요내용`, `결의사항`을 정해진 순서로 확인한다.
- 안건·선임·사업목적 목차나 유효 행이 없는 경우 해당 선택 목록은 빈 목록으로 기록한다.
