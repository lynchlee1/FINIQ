...
**[Core Processing] 외부 HTML 압축 원본 보존 기능**
- **목적:** 압축 record가 가리키는 원본을 검증할 수 있게 보존한다.
- 각 원본을 검증할 수 있도록 HTML의 바이트 수와 SHA-256을 기록한다.
...
**[Core Processing] 뷰어 metadata 일부 반환 기능**
