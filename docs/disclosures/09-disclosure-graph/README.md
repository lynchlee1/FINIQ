...
- 입력 JSON을 읽을 수 없거나 필수 날짜를 지원 형식으로 변환할 수 없으면 실패 처리한다.
<br>
...
**[Result Validation] 저장 결과 오류시 중단하기**
