...
| 단계 | 책임 | 주요 출력 | 문서 |
| --- | --- | --- | --- |
| 01 | KIND 조건검색 결과 다운로드 | `01-list` 원본과 실행 metadata | [01 공시내역 다운로드](01-download.md) |
| 02 | 원본을 검색 가능한 SQLite로 변환 | `02-table/<YYYY>.sqlite` | [02 공시내역 변환](02-table.md) |
| 03 | 공시와 파생 filter의 membership 결정 | `03-filter/<mode>/filtered.json` | [03 공시내역 필터링](03-filter.md) |
| 04 | 외부 HTML 저장과 문서 선택 정보 압축 | `04-external-html-*` | [04 공시원문 외부 저장](04-external-html.md) |
| 05 | 선택한 KIND 본문 HTML 저장 | `05-internal-html-download` | [05 공시원문 내부 저장](05-internal-html.md) |
| 06 | 본문을 목차 단위 HTML로 분리 | `06-sections` | [06 공시원문 목차 분리](06-section-split.md) |
...
| 09 | 공시 주체와 관계를 그래프로 구성 | `09-disclosure-graph` | [09 공시 관계 그래프](09-disclosure-graph.md) |

작업공간, 식별자, 단계 연결, 공통 복구 규칙은 [공시 처리 공통 계약](common.md)에서 관리한다.
