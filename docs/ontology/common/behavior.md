...
- 공시 자료는 [공시분석 공통 동작](../../disclosures/common/behavior.md)에 정한 `01-list`부터 `07-converted`까지 표준 경로를 사용한다. Ontology 화면은 개별 단계 경로를 보내지 않는다.
...
- 공통 표시 규칙은 [공시분석 공통 동작](../../disclosures/common/behavior.md), 비동기 작업 복구 규칙은 [공시분석 예외 사양](../../disclosures/common/reference.md)을 따른다.
